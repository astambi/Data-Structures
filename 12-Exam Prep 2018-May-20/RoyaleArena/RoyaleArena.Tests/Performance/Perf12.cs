...
public class Perf12
{
    ...
    public void GetByTypeAndDamageRangeOrderedByDamageThenById()
    {
        ...
        for (int i = 0; i < 100000; i++)
        {
            ...
            Battlecard cd = new Battlecard(i, CardType.BUILDING, "sender", amount, 15);
            ar.Add(cd);
        ...
        IEnumerable<Battlecard> all = ar
            .GetByTypeAndDamageRangeOrderedByDamageThenById(CardType.BUILDING, 200, 600);
        int c = 0;
