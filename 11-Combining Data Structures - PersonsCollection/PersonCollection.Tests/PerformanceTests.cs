...
public class PerformanceTestsPersonCollection
{
    ...
    public void TestPerformance_FindPersonsByEmailDomain()
    {
        ...
        {
            var existingPersons = persons
                .FindPersons("gmail1.com")
                .ToList();
            Assert.AreEqual(50, existingPersons.Count);

            var notExistingPersons = persons
                .FindPersons("non-existing email")
                .ToList();
    ...
    public void TestPerformance_FindPersonsByNameAndTown()
    {
        ...
        {
            var existingPersons = persons
                .FindPersons("Pesho1", "Sofia1")
                .ToList();
            Assert.AreEqual(50, existingPersons.Count);

            var notExistingPersons = persons
                .FindPersons("Pesho1", "Sofia5")
                .ToList();
            Assert.AreEqual(0, notExistingPersons.Count);
        }
    }
    ...
    public void TestPerformance_FindPersonsByTownAndAgeRange()
    {
        ...
        {
            var existingPersons = persons
                .FindPersons(18, 22, "Sofia20")
                .ToList();
            Assert.AreEqual(50, existingPersons.Count);
            var notExistingTownPersons = persons
                .FindPersons(20, 30, "Missing town")
                .ToList();
            Assert.AreEqual(0, notExistingTownPersons.Count);
            var notExistingAgePersons = persons
                .FindPersons(200, 300, "Sofia1")
                .ToList();
            Assert.AreEqual(0, notExistingTownPersons.Count);
        }
    }
