...
public class PlayWithPersons
{
    public static void Main()
    {
        ...
        personsAge22To28 = persons.FindPersons(22, 8);
        Console.WriteLine("Persons of age 22 ... 8: [{0}]",
            string.Join(", ", personsAge22To28.Select(p => p.Email)));

        personsAge22To28Plovdiv = persons.FindPersons(22, 8, "Plovdiv");
        Console.WriteLine("Persons of age 22 ... 8 from 'Plovdiv': [{0}]",
            string.Join(", ", personsAge22To28Plovdiv.Select(p => p.Email)));

        personsAge22To28Plovdiv = persons.FindPersons(22, 28, null);
        Console.WriteLine("Persons of age 22 ... 28 from '': [{0}]",
            string.Join(", ", personsAge22To28Plovdiv.Select(p => p.Email)));
    }
}
